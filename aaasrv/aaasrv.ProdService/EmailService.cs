...
namespace aaasrv.ProdService
{
	public class EmailService : BaseService, IEmailService
	{
		...
		public async Task SendAsync(ActivateModel model)
		{
			User user = GetCurrentUser();
			int code = new Random().Next(1000, 9999);
			...
			//client.Send(mail);
			//client.SendAsync(mail, "success");
			client.SendCompleted += emailHasSent;
			await client.SendMailAsync(mail);
		}

		private void emailHasSent(object sender, System.ComponentModel.AsyncCompletedEventArgs e)
		{
